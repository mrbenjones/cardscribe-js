...
<html>
  ...
  <body class="-menu-visible">
    <div class="doc-layout">
      ...
      <div class="body page-unique-ids">
        <div class="header-nav">
          <div class="right"><a href="https://github.com/rstacruz/onmount" data-title="rstacruz/onmount" class="iconlink">
              <!-- span.title Open in GitHub--><span class="icon -github"></span></a>
          </div>
        </div>
        <div class="markdown-body"><h1 id="unique-ids">Unique IDs</h1>
<p>The <code>init()</code> and <code>exit()</code> callbacks get passed an object with a unique ID. This ID is guaranteed to be unique for every behavior-element pair. It looks like this:</p>
<blockquote>
<p><code>{ id: &apos;c12&apos; }</code></p>
</blockquote>
<p>This makes it possible to assign event handlers with tags that are unique to that behavior-and-element so that it may be unbound later.</p>
<pre><code class="lang-js">$.onmount(<span class="pl-s">&apos;@hiding-menu&apos;</span>, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params">b</span>) </span>{
  $(<span class="pl-s">&apos;html, body&apos;</span>).on(<span class="pl-s">&apos;scroll.&apos;</span> + b.id, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  })
}, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params">b</span>) </span>{
  $(<span class="pl-s">&apos;html, body&apos;</span>).off(<span class="pl-s">&apos;scroll.&apos;</span> + b.id)
})
</code></pre>

        </div>
        <div class="footer-nav">
          <div class="left"><a href="cleanup.html"><span class="title">Preforming cleanups</span></a></div>
          <div class="right"><a href="idempotency.html"><span class="label">Next: </span><span class="title">Idempotency</span></a></div>
        </div>
      </div>
          ...
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Features</span>
              <ul class="submenu">
                ...
                <li class="menu-item -level-2"><a href="unique-ids.html" class="link title -active link-unique-ids">Unique IDs</a>
                </li>
