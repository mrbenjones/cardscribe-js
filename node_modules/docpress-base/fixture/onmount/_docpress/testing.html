...
<html>
  ...
  <body class="-menu-visible">
    <div class="doc-layout">
      ...
      <div class="body page-testing">
        <div class="header-nav">
          <div class="right"><a href="https://github.com/rstacruz/onmount" data-title="rstacruz/onmount" class="iconlink">
              <!-- span.title Open in GitHub--><span class="icon -github"></span></a>
          </div>
        </div>
        <div class="markdown-body"><h1 id="testing-behaviors">Testing behaviors</h1>
<p>You can trigger just one onmount via <code>$.onmount(SELECTOR)</code>. This is useful for tests.</p>
<pre><code class="lang-js"><span class="pl-k">var</span> $div

beforeEach(<span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  $div = $(<span class="pl-s">&quot;&lt;div class=&apos;js-user-profile&apos; data-user=&apos;rstacruz&apos;&gt;&quot;</span>)
    .appendTo(<span class="pl-s">&apos;body&apos;</span>)

  $.onmount(<span class="pl-s">&apos;.js-user-profile&apos;</span>)
})

afterEach(<span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  $div.remove()
})

it(<span class="pl-s">&apos;renders an avatar&apos;</span>, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  expect($div.html()).to.include(<span class="pl-s">&quot;&lt;img src=&apos;avatars/rstacruz.png&apos;&gt;&quot;</span>)
})
</code></pre>

        </div>
        <div class="footer-nav">
          <div class="left"><a href="automatic-observation.html"><span class="title">Automatic observation</span></a></div>
          <div class="right"><a href="debugging.html"><span class="label">Next: </span><span class="title">Debugging</span></a></div>
        </div>
      </div>
        ...
        <li class="menu-item -level-0 -parent">
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Testing</span>
              <ul class="submenu">
                <li class="menu-item -level-2"><a href="testing.html" class="link title -active link-testing">Testing</a>
                </li>
