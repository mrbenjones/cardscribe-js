...
<p>To turn debug logging on, set <code>onmount.debug</code> to <code>true</code>.</p>
<pre><code class="lang-js">onmount.debug = <span class="pl-c1">true</span>
</code></pre>
<p>If you&apos;d like to do this automatically, you can turn it on by a secret flag:</p>
<pre><code class="lang-js">onmount.debug = (<span class="pl-c1">window</span>.localStorage &amp;&amp;
  <span class="pl-c1">window</span>.localStorage[<span class="pl-s">&apos;onmount_debug&apos;</span>] &amp;&amp;
  <span class="pl-c1">true</span>)
</code></pre>
<p>You can turn it on in your JavaScript console by typing <code>localStorage.onmount_debug = true</code>, and turn it off with <code>delete localStorage.onmount_debug</code>.</p>

        </div>
        <div class="footer-nav">
          <div class="left"><a href="testing.html"><span class="title">Testing</span></a></div>
          <div class="right"><a href="turbolinks.html"><span class="label">Next: </span><span class="title">With Turbolinks</span></a></div>
        </div>
      </div>
          ...
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Testing</span>
              <ul class="submenu">
                ...
                <li class="menu-item -level-2"><a href="debugging.html" class="link title -active link-debugging">Debugging</a>
                </li>
              </ul>
            </li>
