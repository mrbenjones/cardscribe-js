...
<html>
  <head>
    ...
    <title>With Rails</title>
    <meta name="viewport" content="width=device-width">
  </head>
  <body class="-menu-visible">
    <div class="doc-layout">
      <div class="toggle menu-toggle js-menu-toggle"></div>
      <div class="body page-rails">
        <div class="header-nav">
          <div class="right"><a href="https://github.com/rstacruz/onmount" data-title="rstacruz/onmount" class="iconlink">
              <!-- span.title Open in GitHub--><span class="icon -github"></span></a>
          </div>
        </div>
        <div class="markdown-body"><h1 id="using-with-rails">Using with Rails</h1>
<p>Use <a href="https://rails-assets.org/">rails-assets.org</a> to bring <code>onmount</code> on your app.</p>
<pre><code class="lang-rb">source <span class="pl-s">&apos;https://rails-assets.org&apos;</span> <span class="pl-k">do</span>
  gem <span class="pl-s">&apos;rails-assets-onmount&apos;</span>
<span class="pl-k">end</span>
</code></pre>
<p>In your <code>application.js</code>, load it using <code>//= require</code>. If you&apos;re using jQuery, load it before onmount.</p>
<pre><code class="lang-js"><span class="pl-c">//= require jquery</span>
<span class="pl-c">//= require onmount</span>
</code></pre>
<p>You can then use onmount.</p>
...
$.onmount(<span class="pl-s">&apos;.js-tooltip&apos;</span>, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  $(<span class="pl-k">this</span>).tooltip()
})
</code></pre>
<p>If you don&apos;t use jQuery, you can use <code>window.onmount</code> instead.</p>

        </div>
        <div class="footer-nav">
          <div class="left"><a href="turbolinks.html"><span class="title">With Turbolinks</span></a></div>
        </div>
      </div>
          ...
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Integrations</span>
              <ul class="submenu">
                ...
                <li class="menu-item -level-2"><a href="rails.html" class="link title -active link-rails">With Rails</a>
                </li>
              </ul>
            </li>
          </ul>
