...
<html>
  ...
  <body class="-menu-visible">
    <div class="doc-layout">
      ...
      <div class="body page-role">
        <div class="header-nav">
          <div class="right"><a href="https://github.com/rstacruz/onmount" data-title="rstacruz/onmount" class="iconlink">
              <!-- span.title Open in GitHub--><span class="icon -github"></span></a>
          </div>
        </div>
        <div class="markdown-body"><h1 id="role-attributes">Role attributes</h1>
<p>Some recommend <a href="https://github.com/rstacruz/rsjs">using the role attribute</a> to bind your behaviors. To aid this, you can define behaviors as <code>@xxxx</code>, which is shorthand of <code>[role~=&quot;xxxx&quot;]</code>. (This convention is taken from <a href="https://github.com/kossnocorp/role">jquery-role</a>.)</p>
<pre><code class="lang-js">$.onmount(<span class="pl-s">&apos;@hiding-menu&apos;</span>, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="pl-c">/* ... */</span>
})

<span class="pl-c">/* same as $.onmount(&apos;[role~=&quot;hiding-menu&quot;]&apos;, ...) */</span>
</code></pre>

        </div>
        <div class="footer-nav">
          <div class="left"><a href="premise.html"><span class="title">Premise</span></a></div>
          <div class="right"><a href="cancelling.html"><span class="label">Next: </span><span class="title">Cancelling</span></a></div>
        </div>
      </div>
        ...
        <li class="menu-item -level-0 -parent">
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Features</span>
              <ul class="submenu">
                <li class="menu-item -level-2"><a href="role.html" class="link title -active link-role">Role attributes</a>
                </li>
