...
<html>
  ...
  <body class="-menu-visible">
    <div class="doc-layout">
      ...
      <div class="body page-cancelling">
        <div class="header-nav">
          <div class="right"><a href="https://github.com/rstacruz/onmount" data-title="rstacruz/onmount" class="iconlink">
              <!-- span.title Open in GitHub--><span class="icon -github"></span></a>
          </div>
        </div>
        <div class="markdown-body"><h1 id="cancelling">Cancelling</h1>
<p>You can cancel an initialization by returning <code>false</code>. This makes it so that the initialization will run again when <code>init</code> is triggered again.</p>
<p>This is also available for exit callbacks.</p>
<pre><code class="lang-js">$.onmount(<span class="pl-s">&apos;.expandable-nav&apos;</span>, <span class="hljs-function"><span class="pl-k">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="pl-k">if</span> ($(<span class="pl-k">this</span>).is(<span class="pl-s">&apos;:hidden&apos;</span>)) <span class="pl-k">return</span> <span class="pl-c1">false</span>
...
<br>
        ...
        <div class="footer-nav">
          <div class="left"><a href="role.html"><span class="title">Role attributes</span></a></div>
          <div class="right"><a href="cleanup.html"><span class="label">Next: </span><span class="title">Preforming cleanups</span></a></div>
        </div>
      </div>
          ...
          <ul class="submenu">
            ...
            <li class="menu-item -level-1 -parent"><span class="title">Features</span>
              <ul class="submenu">
                ...
                <li class="menu-item -level-2"><a href="cancelling.html" class="link title -active link-cancelling">Cancelling</a>
                </li>
